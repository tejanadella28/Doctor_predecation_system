from flask import Flask, request, render_template, jsonify, flash , url_for  # Added flash
import numpy as np
import pandas as pd
import pickle
...
def get_predicted_value(patient_symptoms):
    ...
    for symptom in patient_symptoms:
        if symptom in symptoms_dict:
            ...
            return "Invalid Symptom: " + symptom  # Return an error if symptom is not found
